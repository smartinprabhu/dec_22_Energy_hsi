...
const CardHeader = (props) => {
  ...
  const [selectedOption, setSelectedOption] = useState<"Dynamic" | "Static">(
  ...
  return (
    <div className="card-header-box-responsive">
      <div className="card-header-inner-box-responsive">
        <h1 className="header-box-title-responsive"style={{ fontSize: fontSize || "2rem" }}>
          <div>
          {showBackButton && (
  <button
    ...
    style={{
      ...
      display: "flex",
      alignItems: "center",
      gap: "5px", // Adds spacing between the symbol and the text
    }}
  >
    <span style={{ fontWeight: "bold" }}>&lt;</span> {/* Symbol "<" */}
    Back
  </button>
)}          </div>
          {headerText}{" "}
      ...
      <Dialog open={infoDialogOpen} onClose={() => setInfoDialogOpen(false)}>
        ...
        <DialogContent className="dailoge1">
          <p>
            <b>Linear:</b> This target progresses in a straight line, moving
            steadily toward a defined endpoint. Adjust inputs to maintain a
            consistent flow and achieve the goal.
          </p>
          <p>
            <b>Dynamic:</b> This target adapts to real-time factors to stay
            aligned with shifting goals. Factors such as operating hours,
            temperature, seasonality, etc.
          </p>
        </DialogContent>
